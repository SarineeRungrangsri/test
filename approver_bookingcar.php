...
<body>
    ...
    <h1 align="center">รอเลือกรถทั้งหมด</h1><p></p>
        <thead>
            <tr>
                <th>รหัส</th>
                <th>งาน</th>
        ...
        <tbody>
            <tr>
              ...
              require_once('connect.php');
                ...
                <td>
                  <a onclick="return confirm('ต้องการที่จะเพิ่มข้อมูล');" class="btn btn-warning" href="approver_editbookingcar.php?id=<?php echo $row["id"];?>">เพิ่มรถ</a>
                </td>
            </tr>
            <?php
                                            }
