...
<!--  -->
        ...
        <form action="admin_editcheckcar.php" method="post" >
		<h1 align="center">แก้ไขรถ</h1><p></p>
  ...
  <div class="input-group-prepend">
    <label class="input-group-text" for="inputGroupSelect01">รหัสเลขทะเบียนรถ</label>
  </div>
  <input type="text" name="car_id" required class="form-control" value="<?php echo $row["car_id"];?>" readonly>
</div>
  </div>
    </div>
    ...
    <label class="input-group-text" for="inputGroupSelect01">ประเภทรถ</label>
                                ...
                                ?>
                                    <select name="cartype_id" class="form-control" required>
                                        <option><?php echo $row["cartype_id"];?><?php echo $row["car_typename"];?></option>
  ...
  <input type="text" name="car_name" required class="form-control" value="<?php echo $row["car_name"];?>">
</div>
  </div>
    </div>
