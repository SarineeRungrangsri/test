      ...
      <main class="main-container">
        ...
        <div class="charts1">
            ...
            <div class="charts-card">
                        ...
                        <h1 align="center">แก้ไขการจอง</h1><p></p>

                            <form action="approver_editcheckbooking.php" method="post" id="schedule-form">
                    ...
                    ?>
                              ...
                              <div class="input-group-prepend">
                                <label class="input-group-text" for="inputGroupSelect01">รหัสกการจอง</label>
                              </div>
                              <input type="text" name="id" required class="form-control" value="<?php echo $row["id"] ?>" readonly>
                              <input type="hidden" name="person_id" required class="form-control" value="<?php echo $row["person_id"] ?>" readonly>
                            </div>
                              </div>
                                </div>
                              ...
                              <input type="text" name="description" required class="form-control" value="<?php echo $row["description"]?>">
                            </div>
                              </div>
                                </div>
                              ...
                              <input type="datetime-local" class="form-control " name="start_datetime" id="start_datetime" required value="<?php echo $row["start_datetime"]?>">
                            </div>
                              </div>
                                </div>
                              ...
                              <input type="datetime-local" class="form-control " name="end_datetime" id="end_datetime" required value="<?php echo $row["end_datetime"]?>">
                            </div>
                              </div>
                                </div>
                              ...
                              <input type="text" name="inventory" required class="form-control" value="<?php echo $row["inventory"]?>">
                            </div>
                              </div>
                                </div>
