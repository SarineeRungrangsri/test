        ...
        <tbody>
            <tr>
              ...
              require_once('connect.php');
                                        ...
                                        $sql=sprintf("SELECT * FROM `schedule_list` WHERE car_status='อนุมัติ'");
                ...
                <td>
                  <a onclick="return confirm('ต้องการที่จะพิมพ์ใบอนุญาต');" target="_black" class="btn btn-primary" href="approver_printbooking.php?id=<?php echo $row['id']; ?>">พิมพ์</a>     
                </td>
            </tr>
            <?php
                                            }
