...
<body>
    ...
    <h1 align="center">รอการอนุมัติทั้งหมด</h1><p></p>
        <thead>
            <tr>
                <th>รหัส</th>
                <th>งาน</th>
        ...
        <tbody>
            <tr>
              ...
              require_once('connect.php');
                ...
                <td>
                  <a onclick="return confirm('ต้องการที่จะเพิ่มข้อมูล');" class="btn btn-warning" href="approver_editapprover.php?id=<?php echo $row["id"];?>">รอการอนุมัติ</a>
                </td>
            </tr>
            <?php
                                            }
