...
if(
    ...
    $_SESSION["person_status"]!="ผู้อนุมัติ" //and
      ...
      <main class="main-container">
        ...
        <div class="charts1">
            ...
            <div class="charts-card">
                        ...
                        <h1 align="center">อนุมัติ</h1><p></p>

                            <form action="approver_editcheckapprover.php" method="post" id="schedule-form">
                    ...
                    ?>
                              ...
                              <div class="input-group-prepend">
                                ...
                                <select class="form-control" name="car_status">
                                        <option value="อนุมัติ" <?php if($row["car_status"]=='อนุมัติ') echo "selected";?>>อนุมัติ</option>
                                        <option value="ไม่อนุมัติ" <?php if($row["car_status"]=='ไม่อนุมัติ') echo "selected";?>>ไม่อนุมัติ</option>
                                    </select>
                            </div>
                              </div>
                                </div>
