...
<!--  -->
    ...
    <form action="admin_savecheckcartype.php" method="post" name="add" class="form-horizontal" id="add">
		<h1 align="center">เพิ่มประเภทรถ</h1><p></p>    
  ...
  <input type="text" name="car_typename" required class="form-control">
</div>
  </div>
    </div>
    ...
    <div align="center">
       <button class="btn btn-success" type="submit" form="add">บันทึก</button>
       <a href="admin_addcartype.php" class="btn btn-danger">ยกเลิก</a>
    </div>
  </div>
	</form>
            </div>
