...
<!--  -->
		...
		<h1 align = 'center'>เพิ่มข้อมูลผู้ใช้</h1><p></p>

    <?php if (isset($_GET['error'])): ?>
        <p><?php echo $_GET['error']?></p>
    <?php endif ?>
 <form action="admin_savecheckperson.php" method="post" class="form-horizontal" enctype="multipart/form-data">
  ...
  <input type="text" name="person_name" required class="form-control" placeholder="ภาษาไทย">
</div>
  </div>
    </div>
  ...
  <input type="text" name="person_username" required class="form-control" placeholder="ชื่อภาษาอังกฤษ">
</div>
  </div>
    </div>
  ...
  <input type="password" name="person_pass" required class="form-control" placeholder="อย่างน้อย 8 ตัว">
</div>
  </div>
    </div>
  ...
  <select name="person_status" class="custom-select" id="inputGroupSelect01" required>
    ...
    <div align="center">
       ...
       <a href = "admin_tableperson.php" class="btn btn-danger">ยกเลิก</a>
    </div>
  </div>
 </form>
	<!-- </form> -->
